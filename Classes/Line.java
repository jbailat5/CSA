public class Line {
	...
	{
        double difX = Math.pow((end2.getX() - end1.getX()), 2);
        double difY = Math.pow((end2.getY() - end1.getY()), 2);
        double doubleDistance = Math.sqrt((difX + difY));
	...
	public Point midpoint()
	{
        ...
        Point newMidPoint = new Point (midX, midY);
        return newMidPoint;
